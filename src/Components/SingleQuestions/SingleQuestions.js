    ...
    return (
        <div className='border shadow-2xl p-5 m-5 '>
            <div className='flex justify-between relative'>
                <h1 className='bg-orange-400 mt-5 lg:h-20 rounded-lg text-xl w-full' >{question.question}</h1>
                <button onClick={correctAnsBtn} className='absolute top-[-3px] left-[1400px] hover:bg-red-600'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
