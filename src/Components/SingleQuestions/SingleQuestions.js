    ...
    return (
        <div className='border shadow-2xl lg:p-5 lg:m-5 lg:w-[1000px] lg:ml-48  '>
            <div className='flex justify-between relative ' >
                ...
                <button onClick={correctAnsBtn} className='absolute top-[-3px] left-[940px] hover:bg-red-600'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
